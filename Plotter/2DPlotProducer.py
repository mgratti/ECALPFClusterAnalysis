...
if __name__ == "__main__":
   ...
   if do_summaryPlot=='True':
      ...
      #fileQte = open("rms_2021_t3-4.txt", "w+")
      ...
      for item in whichQuantities:
         ...
         fileToRead = open("rms_2021_ratio.txt", "r")
...
filer = open("rms_2021_ratio.txt", "w+")
file1 = open("rms_2021_t3-4.txt", "r")
file2 = open("rms_2021_t0.txt")
